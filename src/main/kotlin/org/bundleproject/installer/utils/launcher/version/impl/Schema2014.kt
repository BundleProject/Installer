...
class Schema2014(private val file: File) : VersionJson {
    ...
    override fun addGameArgument(vararg argument: String) {
        val combinedArguments = argument.toList().joinToString(" ")
        val arguments = json.get("minecraftArguments").asString + " " + combinedArguments
        json.addProperty("minecraftArguments", arguments)
    }
